...
system('cls');
system('title Admin Panel  Coded by Clashoff');
...
print "   \n   **************************************************
               ...
               **************************************************\n";
print "     Turkish | AdminPanel Version 1 (Beta)\n";
print "                \n";
print "                           Coded By Clashoff\n\n";
print "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx\n" ;
print "\n";

print " Enter the website you want to scan \n";
print" As an Example: www.hedef.com or www.domains.com/path\n";
print" --> ";
$site=<STDIN>;
chomp $site;
